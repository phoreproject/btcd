...
* Install the MSI available at: https://github.com/phoreproject/btcd/releases
...
btcd has a number of [configuration](http://godoc.org/github.com/phoreproject/btcd)
...
* [Using bootstrap.dat](https://github.com/phoreproject/btcd/tree/master/docs/using_bootstrap_dat.md)

<a name="NetworkConfig" />

**3.1.2 Network Configuration**

* [What Ports Are Used by Default?](https://github.com/phoreproject/btcd/tree/master/docs/default_ports.md)
* [How To Listen on Specific Interfaces](https://github.com/phoreproject/btcd/tree/master/docs/configure_peer_server_listen_interfaces.md)
* [How To Configure RPC Server to Listen on Specific Interfaces](https://github.com/phoreproject/btcd/tree/master/docs/configure_rpc_server_listen_interfaces.md)
* [Configuring btcd with Tor](https://github.com/phoreproject/btcd/tree/master/docs/configuring_tor.md)
...
* [Code Contribution Guidelines](https://github.com/phoreproject/btcd/tree/master/docs/code_contribution_guidelines.md)

<a name="JSONRPCReference" />

* [JSON-RPC Reference](https://github.com/phoreproject/btcd/tree/master/docs/json_rpc_api.md)
    * [RPC Examples](https://github.com/phoreproject/btcd/tree/master/docs/json_rpc_api.md#ExampleCode)
...
* The btcsuite Bitcoin-related Go Packages:
    ...
    * [peer](https://github.com/phoreproject/btcd/tree/master/peer) -
      Provides a common base for creating and managing Bitcoin network peers.
    * [blockchain](https://github.com/phoreproject/btcd/tree/master/blockchain) -
      Implements Bitcoin block handling and chain selection rules
    * [blockchain/fullblocktests](https://github.com/phoreproject/btcd/tree/master/blockchain/fullblocktests) -
      Provides a set of block tests for testing the consensus validation rules
    * [txscript](https://github.com/phoreproject/btcd/tree/master/txscript) -
      Implements the Bitcoin transaction scripting language
    * [btcec](https://github.com/phoreproject/btcd/tree/master/btcec) - Implements
      support for the elliptic curve cryptographic functions needed for the
      Bitcoin scripts
    * [database](https://github.com/phoreproject/btcd/tree/master/database) -
      Provides a database interface for the Bitcoin block chain
    * [mempool](https://github.com/phoreproject/btcd/tree/master/mempool) -
      Package mempool provides a policy-enforced pool of unmined bitcoin
      transactions.
    * [btcutil](https://github.com/phoreproject/btcutil) - Provides Bitcoin-specific
      convenience functions and types
    * [chainhash](https://github.com/phoreproject/btcd/tree/master/chaincfg/chainhash) -
      Provides a generic hash type and associated functions that allows the
      specific hash algorithm to be abstracted.
    * [connmgr](https://github.com/phoreproject/btcd/tree/master/connmgr) -
