...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/phoreproject/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/phoreproject/btcd/blockchain/fullblocktests
```
